...
export class AuthRoutes {
  ...
  private register(): void {
    ...
    this.router.post(
      "/mfa/start",
      AuthMiddleware.attachOptional,
      IdempotencyMiddleware.optionalForMutations(),
      this.authController.startMfa,
    );
    this.router.post(
      "/mfa/verify",
      AuthMiddleware.attachOptional,
    ...
    this.router.post(
      "/password/forgot",
      IdempotencyMiddleware.optionalForMutations(),
      this.authController.startPasswordReset,
    );
    this.router.post(
      "/password/reset",
      IdempotencyMiddleware.optionalForMutations(),
    ...
    this.router.post(
      ...
      this.authController.validatePasswordResetToken,
    );
    this.router.post(
      "/password-reset/complete",
      IdempotencyMiddleware.optionalForMutations(),
      this.authController.completePasswordReset,
    );
    this.router.post(
      "/plan",
      AuthMiddleware.ensureAuthenticated,
      IdempotencyMiddleware.requireForMutations(),
      this.authController.selectPlan,
    );
    this.router.post(
      "/subscription/activate",
      AuthMiddleware.ensureAuthenticated,
      IdempotencyMiddleware.requireForMutations(),
      this.authController.activateSubscription,
    );
    this.router.get(
      "/mfa/methods",
      AuthMiddleware.ensureAuthenticated,
      this.authController.listMfaMethods,
    );
    this.router.get(
      "/sessions",
      AuthMiddleware.ensureAuthenticated,
      this.authController.listSessions,
    );
    this.router.get(
      "/mfa/trust-sessions",
      AuthMiddleware.ensureAuthenticated,
      this.authController.listMfaTrustSessions,
    );
    this.router.delete(
      "/mfa/trust-sessions",
      AuthMiddleware.ensureAuthenticated,
      IdempotencyMiddleware.requireForMutations(),
      this.authController.revokeMfaTrustSession,
    );
    this.router.delete(
      "/mfa/trust-sessions/all",
      AuthMiddleware.ensureAuthenticated,
      IdempotencyMiddleware.requireForMutations(),
      this.authController.revokeAllMfaTrustSessions,
    );
    this.router.delete(
      "/sessions",
      AuthMiddleware.ensureAuthenticated,
    ...
    this.router.post(
      ...
      IdempotencyMiddleware.requireForMutations(),
      this.authController.createRole,
    );
    this.router.get(
      "/roles",
      AuthMiddleware.ensureAuthenticated,
      AuthMiddleware.ensureFullAccess,
      this.authController.listRoles,
    );
    this.router.get(
      "/permissions",
      AuthMiddleware.ensureAuthenticated,
      AuthMiddleware.ensureFullAccess,
      this.authController.listPermissions,
    );
    this.router.post(
      "/users",
      AuthMiddleware.ensureAuthenticated,
