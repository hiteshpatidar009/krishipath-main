...
export class LocalizationModule {
  ...
  public readonly conceptDictionaryService: UniversalConceptDictionaryService;
  private readonly languageController: LanguageController;
  private readonly translationController: TranslationController;
  private readonly dictionaryController: ConceptDictionaryController;
  private readonly localizationRoutes: LocalizationRoutes;
  public readonly languageResolverMiddleware: LanguageResolverMiddleware;
  ...
  constructor() {
    ...
    this.localizationRoutes = new LocalizationRoutes(
   ...
   */
  public getLanguageMiddleware(): RequestHandler {
