...
export class App {
  ...
  private readonly activityLogModule: ActivityLogModule;
  private readonly auditLogModule: AuditLogModule;
  ...
  private readonly fileStorageModule: FileStorageModule;
  ...
  private readonly pushNotificationModule: PushNotificationModule;
  ...
  private readonly mandiModule: MandiModule;
  private readonly farmerModule: FarmerModule;
  private readonly traderModule: TraderModule;
  private readonly marketInsightModule: MarketInsightModule;
  private readonly contentModule: ContentModule;
  private readonly krishiGuruModule: KrishiGuruModule;
  private readonly rewardModule: RewardModule;
  private readonly localizationModule: LocalizationModule;
  private readonly weatherModule: WeatherModule;
  private readonly marketSourceModule: MarketSourceModule;
  ...
  private initializeMiddlewares(): void {
    ...
    this.expressApp.use(
      ...
      express.raw({ type: "application/json", limit: env.requestBodyLimit }),
    );
  ...
  private initializeHealthCheck(): void {
    this.expressApp.get("/health", (_request: Request, response: Response) => {
  ...
  private initializeNotFoundHandler(): void {
    this.expressApp.use((_request: Request, response: Response) => {
