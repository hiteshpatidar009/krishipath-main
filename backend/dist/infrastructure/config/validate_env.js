...
export class EnvValidator {
    ...
    static schema = z.object({
        ...
        const hasDbConfig = (url, host, database, user, password, label) => {
        ...
        hasDbConfig(value._DB_URL_ONE, value._DB_HOST_ONE, value._DB_NAME_ONE, value._DB_USER_ONE, value._DB_PASSWORD_ONE, "DB1");
    ...
    static normalizeEnvironment(env) {
        ...
        for (const [canonicalKey, aliases] of Object.entries(this.aliasMap)) {
            normalizedEnvironment[canonicalKey] = this.resolveAliasedValue(env, aliases);
        }
        return normalizedEnvironment;
    }
    static resolveAliasedValue(env, aliases) {
