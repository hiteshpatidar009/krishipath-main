...
function readExecutionRecords(reportsDir, moduleName) {
...
async function writeModuleWorkbook(reportsDir, moduleName, records) {
...
function addWorksheet(workbook, moduleName, records) {
