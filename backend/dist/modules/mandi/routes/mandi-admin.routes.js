...
export class MandiAdminRoutes {
    ...
    constructor(adminController, cropController, traderController, priceController, productAdminController, locationController, translationService) {
        this.adminController = adminController;
        this.cropController = cropController;
        this.traderController = traderController;
        this.priceController = priceController;
        this.productAdminController = productAdminController;
