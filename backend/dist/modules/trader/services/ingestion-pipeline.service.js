...
export class IngestionPipelineService extends BaseService {
    ...
    dictionaryService;
    mandiPriceService;
    constructor(ingestionRepo, parserService, dictionaryService, mandiPriceService) {
    ...
    async processRawMessage(input) {
        ...
        try {
            ...
            for (const item of parsedItems) {
                ...
                await this.mandiPriceService.updateTraderPrice(feedSource.traderId, // user doing the update
                input.mandiId, variantId, item.pricePerQuintal.toString(), feedSource.traderId, // setBy
